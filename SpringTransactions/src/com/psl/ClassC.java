...
//, , 
	...
	@Transactional (propagation=Propagation.REQUIRED,readOnly=false, noRollbackFor={org.springframework.jdbc.BadSqlGrammarException.class})//t1
	public void method1(){
	...
	public void method2(){
	//try{
			getJdbcTemplate().update("insert into tableb values (7, 'Jill')");
